...
public class PicassoUtils {
    ...
    public static void loadImageViewHolderSize(Context mContext, String url, int loadImg,
                                           int errorImg, ImageView imageView,int width, int height) {
